import type { ActivityEvent, AppNotification, Project, Task, User, UserStory } from "@/types";
...
const taskSeeds: TaskSeed[] = [
  // US-101 — authentication
  {
    ...
    description:
      "Implement POST /auth/login with password hashing, rate limiting and session issuance.",
    status: "done",
    priority: "critical",
    assigneeId: "u3",
    estimatedHours: 8,
  ...
  },
  {
    ...
    projectId: "p1",
    storyId: "s1",
    title: "Login UI and form validation",
    description:
      "Build the sign-in screen with inline field validation and a clear error state for bad credentials.",
    status: "done",
    priority: "high",
    assigneeId: "u5",
    estimatedHours: 6,
  ...
  },
  {
    ...
    description:
      "Refresh tokens silently and redirect to sign-in when a session cannot be renewed.",
    status: "done",
    priority: "medium",
    assigneeId: "u3",
    estimatedHours: 5,
  ...
  // US-102 — dashboard
  {
    ...
    description:
      "Aggregate project, story and task counters in a single endpoint to avoid N+1 reads.",
    status: "in_progress",
    priority: "high",
    assigneeId: "u3",
    estimatedHours: 10,
  ...
  },
  {
    ...
    description:
      "Metric cards, project progress list and upcoming deadline panel with loading skeletons.",
    status: "in_review",
    priority: "high",
    assigneeId: "u4",
    estimatedHours: 12,
  ...
  },
  {
    ...
    description:
      "Render task status distribution and keep colours consistent with the status tokens.",
    status: "todo",
    priority: "medium",
    assigneeId: "u5",
    estimatedHours: 5,
  ...
  },
  {
    ...
    projectId: "p1",
    storyId: "s2",
    title: "Overdue work rollup",
    description: "Compute overdue tasks per project and expose them to the dashboard payload.",
    status: "backlog",
    priority: "low",
    assigneeId: null,
    estimatedHours: 4,
  ...
  // US-103 — team members
  {
    ...
    projectId: "p1",
    storyId: "s3",
    title: "Invite member flow",
    description: "Invite dialog with email validation, role selection and a pending-invite state.",
    status: "in_review",
    priority: "medium",
    assigneeId: "u7",
    estimatedHours: 7,
  ...
  },
  {
    ...
    description: "Server-side role checks for member management routes; deny by default.",
    status: "in_progress",
    priority: "high",
    assigneeId: "u3",
    estimatedHours: 6,
  ...
  },
  {
    ...
    projectId: "p1",
    storyId: "s3",
    title: "Deactivate member confirmation",
    description:
      "Destructive confirmation dialog that explains the consequences before deactivating.",
    status: "todo",
    priority: "low",
    assigneeId: "u6",
    estimatedHours: 3,
  ...
  // US-104 — search
  {
    ...
    projectId: "p1",
    storyId: "s4",
    title: "Search index and query API",
    description: "Full-text search across projects, stories and tasks with ranked results.",
    status: "todo",
    priority: "medium",
    assigneeId: "u3",
    estimatedHours: 9,
  ...
  },
  {
    ...
    description: "Keyboard-driven search dialog with grouped results and arrow-key navigation.",
    status: "todo",
    priority: "medium",
    assigneeId: "u5",
    estimatedHours: 8,
  ...
  // US-201 — inbox
  {
    ...
    description: "Grouped inbox with unread markers, filters and mark-all-as-read.",
    status: "in_progress",
    priority: "high",
    assigneeId: "u6",
    estimatedHours: 8,
  ...
  },
  {
    ...
    projectId: "p2",
    storyId: "s5",
    title: "Notification read-state API",
    description: "Endpoints to mark single and bulk notifications as read, idempotently.",
    status: "in_review",
    priority: "medium",
    assigneeId: "u3",
    estimatedHours: 5,
  ...
  },
  {
    ...
    projectId: "p2",
    storyId: "s5",
    title: "Unread badge polling",
    description: "Poll unread counts with backoff and pause polling when the tab is hidden.",
    status: "todo",
    priority: "low",
    assigneeId: "u7",
    estimatedHours: 4,
  ...
  // US-202 — digest worker
  {
    ...
    projectId: "p2",
    storyId: "s6",
    title: "Digest scheduler job",
    description: "Background job that batches the previous day's events per user.",
    status: "todo",
    priority: "critical",
    assigneeId: "u3",
    estimatedHours: 12,
    labels: ["async", "backend"],
    created: -24,
    updated: -1,
    due: 2,
  },
  {
    ...
    description: "Digest email template with plain-text fallback and safe HTML escaping.",
    status: "backlog",
    priority: "medium",
    assigneeId: "u5",
    estimatedHours: 6,
  ...
  },
  {
    ...
    description: "Exponential backoff for failed sends plus a dead-letter table for inspection.",
    status: "backlog",
    priority: "high",
    assigneeId: null,
    estimatedHours: 7,
    labels: ["async", "reliability"],
    created: -21,
    updated: -6,
    due: 12,
  },
  // US-203 — preferences
  {
    ...
    description: "Per-event notification toggles for in-app and email channels.",
    status: "backlog",
    priority: "low",
    assigneeId: "u7",
    estimatedHours: 5,
  ...
  },
  {
    ...
    projectId: "p2",
    storyId: "s7",
    title: "Preference persistence API",
    description: "Store and read notification preferences with sensible defaults.",
    status: "backlog",
    priority: "low",
    assigneeId: "u3",
    estimatedHours: 4,
  ...
  // US-301 — exports
  {
    ...
    projectId: "p3",
    storyId: "s8",
    title: "CSV export generator",
    description: "Stream large report exports to CSV without loading all rows into memory.",
    status: "todo",
    priority: "high",
    assigneeId: "u4",
    estimatedHours: 9,
  ...
  },
  {
    ...
    projectId: "p3",
    storyId: "s8",
    title: "Schedule picker UI",
    description: "Cadence picker with timezone-aware preview of the next run.",
    status: "backlog",
    priority: "medium",
    assigneeId: "u5",
    estimatedHours: 6,
  ...
  },
  {
    ...
    projectId: "p3",
    storyId: "s8",
    title: "Export history view",
    description: "Table of past exports with status, size and re-download action.",
    status: "backlog",
    priority: "low",
    assigneeId: null,
    estimatedHours: 5,
  ...
  // US-302 — integration
  {
    ...
    description: "Encrypt integration secrets at rest and never return them to the client.",
    status: "backlog",
    priority: "high",
    assigneeId: "u7",
    estimatedHours: 8,
  ...
  },
  {
    ...
    projectId: "p3",
    storyId: "s9",
    title: "Sync worker with pagination",
    description: "Resumable sync worker that walks external pages and records a cursor.",
    status: "backlog",
    priority: "medium",
    assigneeId: "u3",
    estimatedHours: 10,
    labels: ["async", "integration"],
    created: -5,
    updated: -3,
    due: 21,
  },
  // US-303 — performance
  {
    ...
    projectId: "p3",
    storyId: "s10",
    title: "Add covering indexes",
    description: "Index the report query hot paths and document each index and its purpose.",
    status: "backlog",
    priority: "medium",
    assigneeId: "u4",
    estimatedHours: 4,
  ...
  },
  {
    ...
    description: "Log queries above the latency budget with sanitised parameters.",
    status: "backlog",
    priority: "low",
    assigneeId: "u7",
    estimatedHours: 3,
...
export const activity: ActivityEvent[] = [
  {
    ...
    entityId: "t3",
    entityRef: "TASK-203",
    entityTitle: "Session expiry handling",
    projectId: "p1",
    storyId: "s1",
    from: "in_progress",
    to: "done",
  ...
  },
  {
    ...
    entityId: "t4",
    entityRef: "TASK-204",
    entityTitle: "Dashboard metrics API",
    projectId: "p1",
    storyId: "s2",
    to: "u3",
    createdAt: day(0, 7),
  },
  {
    ...
    entityId: "t13",
    entityRef: "TASK-301",
    entityTitle: "Notification inbox UI",
    projectId: "p2",
    storyId: "s5",
    from: "todo",
    to: "in_progress",
  ...
  },
  {
    ...
    entityId: "t5",
    entityRef: "TASK-205",
    entityTitle: "Dashboard UI cards",
    projectId: "p1",
    storyId: "s2",
    from: "in_progress",
    to: "in_review",
  ...
  },
  {
    ...
    entityId: "t16",
    entityRef: "TASK-304",
    entityTitle: "Digest scheduler job",
    projectId: "p2",
    storyId: "s6",
    from: "high",
    to: "critical",
  ...
  },
  {
    ...
    entityId: "s3",
    entityRef: "US-103",
    entityTitle: "Team member management",
    projectId: "p1",
    storyId: "s3",
    createdAt: day(-1, 11),
  },
  {
    ...
    entityId: "t27",
    entityRef: "TASK-407",
    entityTitle: "Slow query logging",
    projectId: "p3",
    storyId: "s10",
    createdAt: day(-4, 10),
  },
  ...
  },
  {
    ...
    entityId: "t6",
    entityRef: "TASK-206",
    entityTitle: "Status distribution chart",
    projectId: "p1",
    storyId: "s2",
    from: "in 2 days",
    to: "in 4 days",
  ...
  },
  {
    ...
    entityId: "t14",
    entityRef: "TASK-302",
    entityTitle: "Notification read-state API",
    projectId: "p2",
    storyId: "s5",
    from: "in_progress",
    to: "in_review",
